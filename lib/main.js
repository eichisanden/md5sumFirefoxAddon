...
cm.Item({
  label: "MD5SUM",
  image: data.url("images/icon_016.png"),
  context: cm.SelectorContext("a"),
  contentScriptFile: [data.url("js/lib/jquery-2.1.3.js"), data.url("js/lib/md5.js"), data.url("js/lib/encoding.js"), data.url("js/cs-content-menu.js")],
